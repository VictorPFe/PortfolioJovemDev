  ...
  return (
    <header className="bg-[#0D1117] relative">
      ...
      <div className="flex justify-center">
        <div className="relative lg:w-[1280] mx-10 md:mx-20 lg:mx-50 flex flex-col xl:flex-row justify-center items-center pt-44 pb-34 z-10">
          <div className="text-white">
            ...
            <p className="text-[#D3D3D3] text-lg leading-relaxed mr-20">
              Desenvolvedor Front-End apaixonado por criar interfaces modernas,
              performáticas e centradas no usuário. Com expertise em React,
              Next.js, TypeScript e Tailwind CSS, alio design e tecnologia para
              transformar ideias complexas em experiências digitais intuitivas e
              envolventes. Tenho um olhar atento aos detalhes e foco em
              usabilidade, desempenho e código limpo. Minha missão é entregar
              soluções que encantem tanto usuários quanto equipes de produto.
            </p>
          </div>
